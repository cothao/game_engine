...
void Cube::render(glm::mat4 projection, glm::mat4 view, glm::vec3 cameraPos, glm::vec3 lightPos)
{
    ...
    this->shader.setVec3("color", this->Color.r, this->Color.g, this->Color.b);
    this->shader.setVec3("lightColor", 1., 1., 1.);

    glDrawArrays(GL_TRIANGLES, 0, 36);
}

void Cube::setLightPos(glm::vec3 lightPos)
{
    this->lightPos = lightPos;
}